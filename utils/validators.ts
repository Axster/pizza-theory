...
export function validateInput(params: DoughParams, yeastCalculated: number): ValidationError[] {
  ...
  // Absolute Base Limits (Strict Minimums and Maximums)
  ...
  // Logical constraints on yeast calculation result relative to yeast TYPE (Per Kg of dough)
  ...
  // Proportional Heuristic Cross-checks (Only if explicit inputs cross >= 2 fields)
